...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().authorizeRequests().antMatchers("/paypal/start").permitAll()
				...
				.antMatchers("/location/create").permitAll().antMatchers("/location/delete")
				.hasAuthority("LOCATION_AND_EVENT_ADMIN_ROLE").antMatchers("/location/update")
				.hasAuthority("LOCATION_AND_EVENT_ADMIN_ROLE").antMatchers("/location/all")
				.hasAuthority("LOCATION_AND_EVENT_ADMIN_ROLE").antMatchers("/location/one")
				.hasAuthority("LOCATION_AND_EVENT_ADMIN_ROLE").antMatchers("/location/myLocations")
				.hasAuthority("LOCATION_AND_EVENT_ADMIN_ROLE").antMatchers("/login").permitAll().anyRequest()
